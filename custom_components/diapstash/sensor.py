    ...
    def extra_state_attributes(self) -> dict[str, object]:
        ...
        if self.entity_description.key == "current_diaper":
            return {
                ...
                "boosters_count": data.boosters_count,
                "boosters_label": data.boosters_label,
                "change_tags": list(data.change_tags),
                "change_tags_label": data.change_tags_label,
                "change_note": data.change_note,
                "change_has_note": data.change_has_note,
